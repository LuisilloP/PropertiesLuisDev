        ...
        <section className='contenedor flex flex-col gap-5 pt-10 px-5 md:px-30 lg:px-40'>
          ...
          <div>
            <PropertyContextProvider>
              <PropertyCard cant={3}></PropertyCard>
            </PropertyContextProvider>
          </div>
        </section>
        <section className='contenedor bg-zinc-800 mt-5 text-white gap-5 py-10 px-5 md:px-30 lg:px-40'>
          ...
          <div className='flex justify-center pt-5 md:pt-0'>
            <button type="button" className="text-white bg-gradient-to-br from-green-400 to-blue-600 hover:bg-gradient-to-bl focus:ring-4 focus:outline-none focus:ring-green-200 dark:focus:ring-green-800 font-medium rounded-lg text-sm px-5 duration-500  py-2.5 text-center mr-2 mb-2 w-40">Contacto</button>
          </div>
        </section>
